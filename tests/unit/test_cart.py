...
from modules.carts.utils import (
...
from modules.db.models import Product, Cart, ShippingMethod, Address
...
class TestCartUtils(BaseTest):
    ...
    @patch('modules.carts.utils.stripe.checkout.Session')
    ...
    def test_apply_discount_code_success(self):
        from modules.db.models import Discount
    ...
    @patch('modules.carts.utils.stripe.StripeError', Exception)
